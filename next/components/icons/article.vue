<template>
  ...
  >
    ...
    <path
      opacity="0.4"
      d="M22 11.78C22.13 14.93 19.39 17.5 16.24 17.5H14.01C13.46 17.5 13.01 17.05 13.01 16.5V7.5C13.01 6.95 13.46 6.5 14.01 6.5H16.51C18.03 6.5 19.4 7.12 20.4 8.11C21.33 9.06 21.94 10.35 22 11.78Z"
      fill="currentColor"
    />
    <path
